        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <?php 
                if(isset($_POST['simpan_kategori'])){
                    ...
                    // agar user tidak inputkan nama kategori asal-asalan
                    $queryBlockname = mysqli_query($mysqli, "SELECT nama FROM kategori WHERE nama='$kategori'"); 
                    $jumlahDataKategoriBaru = mysqli_num_rows($queryBlockname);

                    if($jumlahDataKategoriBaru > 0){
                        ?>
                            <div class="alert alert-warning mt-3" role="alert">
                                Nama Kategori Ini Sudah Ada
                            </div>
                        <?php
                    }
                    else{
